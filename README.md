...
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.79.11](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.79.11), 1 day ago) - VSCode public API plugged on the monaco editor
- [dlvhdr/gh-dash](https://github.com/dlvhdr/gh-dash) ([v3.9.0](https://github.com/dlvhdr/gh-dash/releases/tag/v3.9.0), 6 days ago) - A beautiful CLI dashboard for GitHub 🚀 
...
- [lewis6991/whatthejump.nvim](https://github.com/lewis6991/whatthejump.nvim) - Show jumplist in a floating window. (2 days ago)
