...
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.79.1](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.79.1), 3 days ago) - VSCode public API plugged on the monaco editor
- [joshmedeski/t-smart-tmux-session-manager](https://github.com/joshmedeski/t-smart-tmux-session-manager) ([v1.8.1](https://github.com/joshmedeski/t-smart-tmux-session-manager/releases/tag/v1.8.1), 4 days ago) - t - the smart tmux session manager
...
- [romgrk/kirby.nvim](https://github.com/romgrk/kirby.nvim) - Fuzzy picker for neovim - using kitty graphics protocol (2 days ago)
