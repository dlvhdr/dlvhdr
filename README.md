...
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.79.3](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.79.3), 1 day ago) - VSCode public API plugged on the monaco editor
...
- [romgrk/kui.nvim](https://github.com/romgrk/kui.nvim) - UI neovim framework for kitty (4 days ago)
