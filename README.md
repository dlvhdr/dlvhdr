...
- [joshmedeski/t-smart-tmux-session-manager](https://github.com/joshmedeski/t-smart-tmux-session-manager) ([v1.8.1](https://github.com/joshmedeski/t-smart-tmux-session-manager/releases/tag/v1.8.1), today) - t - the smart tmux session manager
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.79.0](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.79.0), 3 days ago) - VSCode public API plugged on the monaco editor
