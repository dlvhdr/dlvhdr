...
- [calcom/cal.com](https://github.com/calcom/cal.com) ([v5.0.10](https://github.com/calcom/cal.com/releases/tag/v5.0.10), 1 day ago) - Scheduling infrastructure for absolutely everyone.
...
- [sinclairzx81/typebox](https://github.com/sinclairzx81/typebox) - Json Schema Type Builder with Static Type Resolution for TypeScript (today)
- [bogzbonny/yeehaw](https://github.com/bogzbonny/yeehaw) - TUI Framework With Batteries Included (1 day ago)
...
- [go-sprout/sprout](https://github.com/go-sprout/sprout) - From sprig to sprout - Useful template functions for Go templates with steroids (3 days ago)
- [mocki-toki/barik](https://github.com/mocki-toki/barik) - macOS menu bar replacement, with yabai and AeroSpace support (4 days ago)
