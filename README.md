...
- [dlvhdr/gh-dash](https://github.com/dlvhdr/gh-dash) ([v4.5.4](https://github.com/dlvhdr/gh-dash/releases/tag/v4.5.4), 1 day ago) - A beautiful CLI dashboard for GitHub 🚀 
- [calcom/cal.com](https://github.com/calcom/cal.com) ([v4.3.6](https://github.com/calcom/cal.com/releases/tag/v4.3.6), 1 week ago) - Scheduling infrastructure for absolutely everyone.

#### ⭐ Recent Stars

- [max397574/care.nvim](https://github.com/max397574/care.nvim) - care.nvim - Completion And Recommendation Engine for Neovim - WIP (today)
- [josean-dev/dev-environment-files](https://github.com/josean-dev/dev-environment-files) -  (4 days ago)
