...
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.78.6](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.78.6), 1 day ago) - VSCode public API plugged on the monaco editor
...
- [aaronhallaert/advanced-git-search.nvim](https://github.com/aaronhallaert/advanced-git-search.nvim) - Search your git history by commit message, content and author in Neovim (3 days ago)
