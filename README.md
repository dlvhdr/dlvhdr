...
- [dlvhdr/diffnav](https://github.com/dlvhdr/diffnav) ([v0.9.0](https://github.com/dlvhdr/diffnav/releases/tag/v0.9.0), 5 days ago) - A git diff pager based on delta but with a file tree, à la GitHub.
