...
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.76.9](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.76.9), today) - VSCode public API plugged on the monaco editor
