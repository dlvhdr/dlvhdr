...
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.76.0](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.76.0), 4 days ago) - VSCode public API plugged on the monaco editor
...
- [xaviergodart/bubble-carousel](https://github.com/xaviergodart/bubble-carousel) - 🎠 A carousel component for bubbletea applications (1 day ago)
- [basilioss/mdt](https://github.com/basilioss/mdt) - Command line markdown todo list manager  (3 days ago)
