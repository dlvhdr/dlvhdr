...
- [dlvhdr/diffnav](https://github.com/dlvhdr/diffnav) ([v0.2.6](https://github.com/dlvhdr/diffnav/releases/tag/v0.2.6), 1 day ago) - A git diff pager based on delta but with a file tree, à la GitHub.
