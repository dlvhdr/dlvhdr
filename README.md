...
- [dlvhdr/gh-dash](https://github.com/dlvhdr/gh-dash) ([v4.8.1](https://github.com/dlvhdr/gh-dash/releases/tag/v4.8.1), 4 days ago) - A beautiful CLI dashboard for GitHub 🚀 
- [calcom/cal.com](https://github.com/calcom/cal.com) ([v4.8.7](https://github.com/calcom/cal.com/releases/tag/v4.8.7), 5 days ago) - Scheduling infrastructure for absolutely everyone.
...
- [yazi-rs/flavors](https://github.com/yazi-rs/flavors) - Some Yazi flavors maintained by community. (4 days ago)
- [LitRidl/EdenVim](https://github.com/LitRidl/EdenVim) - A perfect starting point for your personal, full-featured Neovim config. No fancy abstractions — just plain and simple. You can use it on NixOS, btw. (4 days ago)
...
- [luckasRanarison/tailwind-tools.nvim](https://github.com/luckasRanarison/tailwind-tools.nvim) - An unofficial Tailwind CSS integration and tooling for Neovim (1 week ago)
