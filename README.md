...
- [dlvhdr/diffnav](https://github.com/dlvhdr/diffnav) ([v0.1.1](https://github.com/dlvhdr/diffnav/releases/tag/v0.1.1), today) - A git diff pager based on delta but with a file tree, à la GitHub.
