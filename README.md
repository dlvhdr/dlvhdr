...
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.69.15](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.69.15), today) - VSCode public API plugged on the monaco editor
