...
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.69.21](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.69.21), 3 days ago) - VSCode public API plugged on the monaco editor
...
- [humanlogio/humanlog](https://github.com/humanlogio/humanlog) - Logs for humans to read. (6 days ago)
