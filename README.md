...
- [dlvhdr/homebrew-formulae](https://github.com/dlvhdr/homebrew-formulae) -  (5 days ago)
...
- [dlvhdr/diffnav](https://github.com/dlvhdr/diffnav) ([v0.2.4](https://github.com/dlvhdr/diffnav/releases/tag/v0.2.4), 1 day ago) - A git diff pager based on delta but with a file tree, à la GitHub.
- [calcom/cal.com](https://github.com/calcom/cal.com) ([v4.5.7](https://github.com/calcom/cal.com/releases/tag/v4.5.7), 3 days ago) - Scheduling infrastructure for absolutely everyone.
...
- [pomdtr/fsrouter](https://github.com/pomdtr/fsrouter) - A file system based router for Deno &amp; Deno Deploy. (1 day ago)
- [TwoBitCoders/jx](https://github.com/TwoBitCoders/jx) - jx: Memory-Safe JSON Processing using JavaScript implemented in Go (3 days ago)
- [ceuk/git-file-history](https://github.com/ceuk/git-file-history) - Browse all changes to a file (5 days ago)
- [OXY2DEV/helpview.nvim](https://github.com/OXY2DEV/helpview.nvim) - Decorations for vimdoc/help files in Neovim (5 days ago)
