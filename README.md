...
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.79.2](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.79.2), today) - VSCode public API plugged on the monaco editor
