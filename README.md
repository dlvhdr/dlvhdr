...
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.78.6](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.78.6), today) - VSCode public API plugged on the monaco editor
