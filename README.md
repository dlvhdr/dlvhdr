...
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.69.14](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.69.14), 1 day ago) - VSCode public API plugged on the monaco editor
...
- [dudykr/stc](https://github.com/dudykr/stc) - Speedy TypeScript type checker (1 day ago)
