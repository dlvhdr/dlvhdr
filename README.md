...
- [dlvhdr/gh-dash](https://github.com/dlvhdr/gh-dash) ([v4.0.0](https://github.com/dlvhdr/gh-dash/releases/tag/v4.0.0), 5 days ago) - A beautiful CLI dashboard for GitHub 🚀 
...
- [ChrisBuilds/terminaltexteffects](https://github.com/ChrisBuilds/terminaltexteffects) - Visual effects applied to text in the terminal. (1 day ago)
- [jesseduffield/lazydocker](https://github.com/jesseduffield/lazydocker) - The lazier way to manage everything docker (4 days ago)
- [cshuaimin/ssr.nvim](https://github.com/cshuaimin/ssr.nvim) - Treesitter based structural search and replace plugin for Neovim. (4 days ago)
