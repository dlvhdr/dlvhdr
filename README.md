...
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.76.4](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.76.4), 5 days ago) - VSCode public API plugged on the monaco editor
...
- [caarlos0/dotfiles.nix](https://github.com/caarlos0/dotfiles.nix) - my dotfiles, now in nix (3 days ago)
