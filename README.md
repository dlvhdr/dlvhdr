...
- [port-experimental/port-cli](https://github.com/port-experimental/port-cli) ([v0.3.7](https://github.com/port-experimental/port-cli/releases/tag/v0.3.7), 1 day ago) - CLI for Port — enables developers to interact and manage Port programmatically.
- [dlvhdr/gh-dash](https://github.com/dlvhdr/gh-dash) ([v4.25.0](https://github.com/dlvhdr/gh-dash/releases/tag/v4.25.0), 4 days ago) - A rich terminal UI for GitHub that doesn&#39;t break your flow.
- [charmbracelet/lipgloss](https://github.com/charmbracelet/lipgloss) ([v2.0.5](https://github.com/charmbracelet/lipgloss/releases/tag/v2.0.5), 5 days ago) - Style definitions for nice terminal layouts 👄

#### ⭐ Recent Stars

- [RiskyMH/honeypot](https://github.com/RiskyMH/honeypot) - 🍯 A Discord bot to automatically catch and ban spam bots by monitoring a dedicated &#34;honeypot&#34; channel. (4 days ago)
