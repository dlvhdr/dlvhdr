...
- [dlvhdr/diffnav](https://github.com/dlvhdr/diffnav) ([v0.6.0](https://github.com/dlvhdr/diffnav/releases/tag/v0.6.0), 2 days ago) - A git diff pager based on delta but with a file tree, à la GitHub.
