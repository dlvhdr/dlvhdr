...
- [chipsenkbeil/choose](https://github.com/chipsenkbeil/choose) - Fuzzy matcher for OS X that uses both std{in,out} and a native GUI (2 days ago)
- [DaltonSW/prism](https://github.com/DaltonSW/prism) - Turn raw test output into beautiful data (2 days ago)
- [magit/forge](https://github.com/magit/forge) - Work with Git forges from the comfort of Magit (6 days ago)
- [dhth/kplay](https://github.com/dhth/kplay) - Inspect messages in a Kafka topic in a simple and deliberate manner (6 days ago)
