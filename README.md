...
- [calcom/cal.com](https://github.com/calcom/cal.com) ([v5.2.6](https://github.com/calcom/cal.com/releases/tag/v5.2.6), today) - Scheduling infrastructure for absolutely everyone.
...
- [shalev007/restbook](https://github.com/shalev007/restbook) - RestBook is an open-source CLI tool for orchestrating complex API workflows using simple YAML playbooks. (today)
- [thiagokokada/gh-gfm-preview](https://github.com/thiagokokada/gh-gfm-preview) - A standalone/GitHub CLI extension to preview GitHub Flavored Markdown, even offline. (4 days ago)
- [JustAman62/undercut-f1](https://github.com/JustAman62/undercut-f1) - F1 Live Timing TUI for all F1 sessions with variable delay to sync to your TV. Supports replaying previously recorded sessions. (5 days ago)
