...
- [dlvhdr/diffnav](https://github.com/dlvhdr/diffnav) ([v0.9.0](https://github.com/dlvhdr/diffnav/releases/tag/v0.9.0), 3 days ago) - A git diff pager based on delta but with a file tree, à la GitHub.
- [dlvhdr/gh-enhance](https://github.com/dlvhdr/gh-enhance) ([v0.4.1](https://github.com/dlvhdr/gh-enhance/releases/tag/v0.4.1), 5 days ago) - A Blazingly Fast Terminal UI for GitHub Actions
