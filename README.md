...
- [dlvhdr/gh-dash](https://github.com/dlvhdr/gh-dash) ([v4.16.0](https://github.com/dlvhdr/gh-dash/releases/tag/v4.16.0), 2 days ago) - A beautiful CLI dashboard for GitHub 🚀 
- [calcom/cal.com](https://github.com/calcom/cal.com) ([v5.3.8](https://github.com/calcom/cal.com/releases/tag/v5.3.8), 5 days ago) - Scheduling infrastructure for absolutely everyone.
...
- [microsoft/tui-test](https://github.com/microsoft/tui-test) - An end-to-end terminal testing framework for CLI and TUI experiences (2 days ago)
