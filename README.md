...
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.76.4](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.76.4), today) - VSCode public API plugged on the monaco editor
