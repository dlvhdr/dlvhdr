...
- [port-experimental/port-cli](https://github.com/port-experimental/port-cli) ([v0.2.18](https://github.com/port-experimental/port-cli/releases/tag/v0.2.18), 5 days ago) - CLI for Port — enables developers to interact and manage Port programmatically.
...
- [razakadam74/gitmsg](https://github.com/razakadam74/gitmsg) - Fast, offline, deterministic Conventional Commit message generator. No LLM, no API key, no network. (today)
