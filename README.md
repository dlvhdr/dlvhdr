...
- [calcom/cal.com](https://github.com/calcom/cal.com) ([v5.1.14](https://github.com/calcom/cal.com/releases/tag/v5.1.14), 1 day ago) - Scheduling infrastructure for absolutely everyone.
- [dlvhdr/gh-dash](https://github.com/dlvhdr/gh-dash) ([v4.14.0](https://github.com/dlvhdr/gh-dash/releases/tag/v4.14.0), 5 days ago) - A beautiful CLI dashboard for GitHub 🚀 
...
- [dandavison/delta](https://github.com/dandavison/delta) - A syntax-highlighting pager for git, diff, grep, and blame output (5 days ago)
- [elva-labs/awsesh](https://github.com/elva-labs/awsesh) - A charming TUI for AWS SSO session management ✨ (5 days ago)
- [croian/mouseless](https://github.com/croian/mouseless) - Bug tracking and more for Mouseless (1 week ago)
- [ynqa/sig](https://github.com/ynqa/sig) - Interactive grep (for streaming) (1 week ago)
- [ynqa/empiriqa](https://github.com/ynqa/empiriqa) - For empiricists... (2 weeks ago)
