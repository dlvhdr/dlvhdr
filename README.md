...
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.76.5](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.76.5), 1 day ago) - VSCode public API plugged on the monaco editor
...
- [caarlos0/dotfiles.nix](https://github.com/caarlos0/dotfiles.nix) - my dotfiles, now in nix (4 days ago)
