...
- [calcom/cal.com](https://github.com/calcom/cal.com) ([v4.6.16](https://github.com/calcom/cal.com/releases/tag/v4.6.16), 1 day ago) - Scheduling infrastructure for absolutely everyone.
...
- [vitest-dev/vitest](https://github.com/vitest-dev/vitest) - Next generation testing framework powered by Vite. (1 day ago)
- [LnL7/nix-darwin](https://github.com/LnL7/nix-darwin) - nix modules for darwin (4 days ago)
- [daliusd/ghlite.nvim](https://github.com/daliusd/ghlite.nvim) - Neovim plugin to work GitHub PRs quickly. (6 days ago)
