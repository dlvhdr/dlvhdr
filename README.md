...
- [dlvhdr/gh-dash](https://github.com/dlvhdr/gh-dash) ([v4.9.1](https://github.com/dlvhdr/gh-dash/releases/tag/v4.9.1), 1 day ago) - A beautiful CLI dashboard for GitHub 🚀 
- [calcom/cal.com](https://github.com/calcom/cal.com) ([v4.8.16](https://github.com/calcom/cal.com/releases/tag/v4.8.16), 2 days ago) - Scheduling infrastructure for absolutely everyone.
- [dlvhdr/diffnav](https://github.com/dlvhdr/diffnav) ([v0.3.0](https://github.com/dlvhdr/diffnav/releases/tag/v0.3.0), 5 days ago) - A git diff pager based on delta but with a file tree, à la GitHub.

#### ⭐ Recent Stars

- [chshersh/github-tui](https://github.com/chshersh/github-tui) - 🌒 A TUI for GitHub (today)
- [plp13/qman](https://github.com/plp13/qman) - A more modern man page viewer for our terminals (4 days ago)
