...
- [calcom/cal.com](https://github.com/calcom/cal.com) ([v4.3.5](https://github.com/calcom/cal.com/releases/tag/v4.3.5), 1 day ago) - Scheduling infrastructure for absolutely everyone.
- [dlvhdr/gh-dash](https://github.com/dlvhdr/gh-dash) ([v4.5.2](https://github.com/dlvhdr/gh-dash/releases/tag/v4.5.2), 1 day ago) - A beautiful CLI dashboard for GitHub 🚀 

#### ⭐ Recent Stars

- [ajeetdsouza/zoxide](https://github.com/ajeetdsouza/zoxide) - A smarter cd command. Supports all major shells. (6 days ago)
- [Textualize/textual](https://github.com/Textualize/textual) - The lean application framework for Python.  Build sophisticated user interfaces with a simple Python API. Run your apps in the terminal and a web browser. (6 days ago)
