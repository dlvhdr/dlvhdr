...
- [uribrecher](https://github.com/uribrecher) (2 weeks ago)
...
- [dlvhdr/gh-dash](https://github.com/dlvhdr/gh-dash) ([v4.25.0](https://github.com/dlvhdr/gh-dash/releases/tag/v4.25.0), 2 days ago) - A rich terminal UI for GitHub that doesn&#39;t break your flow.
- [charmbracelet/lipgloss](https://github.com/charmbracelet/lipgloss) ([v2.0.5](https://github.com/charmbracelet/lipgloss/releases/tag/v2.0.5), 3 days ago) - Style definitions for nice terminal layouts 👄
- [port-experimental/port-cli](https://github.com/port-experimental/port-cli) ([v0.3.5](https://github.com/port-experimental/port-cli/releases/tag/v0.3.5), 4 days ago) - CLI for Port — enables developers to interact and manage Port programmatically.

#### ⭐ Recent Stars

- [RiskyMH/honeypot](https://github.com/RiskyMH/honeypot) - 🍯 A Discord bot to automatically catch and ban spam bots by monitoring a dedicated &#34;honeypot&#34; channel. (2 days ago)
- [kapilpokhrel/regexplain](https://github.com/kapilpokhrel/regexplain) - A terminal UI for explaining and visualizing regular expressions, kindof like regex101. (6 days ago)
- [SoCkEt7/Livediff](https://github.com/SoCkEt7/Livediff) - ⚡ Livediff: Watch file diffs live in your terminal. Minimalist Rust TUI for instant feedback loops. (6 days ago)
