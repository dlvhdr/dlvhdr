...
- [CodinGame/monaco-vscode-api](https://github.com/CodinGame/monaco-vscode-api) ([v1.78.6](https://github.com/CodinGame/monaco-vscode-api/releases/tag/v1.78.6), 2 weeks ago) - VSCode public API plugged on the monaco editor
...
- [antfu/ni](https://github.com/antfu/ni) - 💡 Use the right package manager (2 days ago)
- [joshmedeski/tmux-fzf-url](https://github.com/joshmedeski/tmux-fzf-url) - 🚀 Quickly open urls on your terminal screen! (2 days ago)
